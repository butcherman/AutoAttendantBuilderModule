...
class AutoAttendantBuilderModuleServiceProvider extends ServiceProvider
{
    protected $moduleName      = 'AutoAttendantBuilderModule';
    protected $moduleNameLower = 'autoattendantbuildermodule';
